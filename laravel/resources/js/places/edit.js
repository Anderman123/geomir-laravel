...
if (form) {
    form.addEventListener("submit", function(event) {
        ...
        // [...]
        let errorDiv = document.getElementById("file-upload-error-edit")
        ...
        if (validation.passes()) {
            ...
            for (let inputName in errors) {
                ...
                // [...]
                errorDiv.innerText = "Verifica que todos los campos se han completado:(Pista: hay que seleccionar una imagen)"; // Establece el mensaje de error
